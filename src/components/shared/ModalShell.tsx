...
export function ModalShell({ onClose, width = 520, z = 50, dismissOnBackdrop = false, children }: ShellProps) {
  return (
...
export function ModalSection({
  ...
  return (
    <div className="flex flex-col gap-2">
      {title && (
        <div className="text-[10px] font-semibold text-slate-400 uppercase tracking-wider border-b border-slate-700 pb-1">
          {title}
        </div>
      )}
