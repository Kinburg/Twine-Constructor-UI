...
interface ShellProps {
    ...
    z?: number,
    /** If true, clicking the backdrop calls onClose. Default true. */
    dismissOnBackdrop?: boolean,
    children: ReactNode,
    height?: number
}

export function ModalShell({onClose, width = 520, z = 50, dismissOnBackdrop = true, children, height}: ShellProps) {
    return (
