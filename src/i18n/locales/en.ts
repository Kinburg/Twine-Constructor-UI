...
const en: Translations = {
  ...
  styleOverride: {
    ...
    rawCssSelectorBody:  'dialogue bubble (background, border, padding, border-radius, shadow...)',
    rawCssSelectorName:  'character name (color, font, letter-spacing...)',
    rawCssSelectorText:  'speech text (color, line-height, font-family...)',
    rawCssSelectorAvatar:'avatar image (border-radius, border, shadow, size...)',
