...
const en: Translations = {
  ...
  avatarGen: {
    ...
    seedLock: 'Lock seed',
    seedRandomize: '🎲',
    refImageCheckbox: 'Pass as ${charImage}',
    refImageTooltip: 'Encode this image as Base64 and inject it into the ComfyUI workflow as ${charImage}. Use a LoadImageFromBase64 node (or similar) in your workflow to receive it.',
    hintLabel: 'Hint:',
